...
- (NSString *)legendForValue:(u_long)value
{
    ...
    if (value > 4194304) returnValue = [NSString stringWithFormat:@"%luM",value/1048576];
    else if (value > 4096) returnValue = [NSString stringWithFormat:@"%luK",value/1024];
    else returnValue = [NSString stringWithFormat:@"%lu",value];
    return returnValue;
}
